...
from recommendations import song_recommendations, playlist_recommendations, prompt_recommendations
import json
...
def home():
    ...
    st.session_state.input_text = {"age": age, "location": location, "mood": mood, "genre": genre,
                                   "requirement": requirement}
    st.button('Get Prompt Recommendations', on_click=prompt_recommendations)
